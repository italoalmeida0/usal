...
// src/integrations/solid.js
var USALContext = (0, import_solid_js.createContext)();
var USALProvider = (props) => {
  let instance = null;
  (0, import_solid_js.onMount)(() => {
    instance = usal_default.createInstance();
...
var useUSAL = (config = {}) => {
  const contextInstance = (0, import_solid_js.useContext)(USALContext);
  let instance = null;
  (0, import_solid_js.onMount)(() => {
    if (contextInstance) {
...
var Animated = (props) => {
  ...
  const dataUsal = (0, import_solid_js.createMemo)(() => {
...
var solid_default = usal_default;
